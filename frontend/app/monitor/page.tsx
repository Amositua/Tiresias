...
function HorizonChip({ horizon, value }: { horizon: string; value: string }) {
  return (
    <div className="flex items-center gap-2">
      <span className="text-cream-300/30 text-[10px] uppercase tracking-widest">{horizon}</span>
      <span className="text-cream-300/50 text-[10px] font-mono">{value}</span>
    </div>
  );
}
    ...
    <div className="flex flex-col h-screen bg-navy-950 text-cream-100 overflow-hidden">
      <header className="flex items-center justify-between px-6 py-3 border-b border-navy-700 bg-navy-900 flex-shrink-0 h-12">
        <div className="flex items-center gap-3">
          <Link href="/" className="font-serif text-base text-cream-100 tracking-wide hover:text-gold-400 transition-colors">
            Tiresias
          </Link>
      ...
      <div className="flex items-center gap-0 px-6 border-b border-navy-700 bg-navy-900/50 flex-shrink-0 h-8">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex flex-col overflow-hidden" style={{ flex: "0 0 45%" }}>
          <div className="px-6 py-3 border-b border-navy-700 flex-shrink-0">
            <span className="text-cream-300/30 text-xs tracking-widest uppercase">Oracle</span>
          </div>
