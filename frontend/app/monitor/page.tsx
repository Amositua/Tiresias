...
import { Verdict, GraphNode, GraphEdge, MonitoringSummary, PsiTrendPoint, TableFreshness, ConnectorHealth, RiskForecast } from "@/lib/types";
        ...
        <div className="flex flex-col overflow-hidden" style={{ flex: "0 0 43%" }}>
          ...
          <div className="flex-1 overflow-y-auto">
            {verdict ? (
              ...
              <MonitoringDataPanel summary={summary} trend={trend} freshness={freshness} connectorHealth={connectorHealth} riskForecast={riskForecast} />
            )}
          </div>
        </div>
      </div>
